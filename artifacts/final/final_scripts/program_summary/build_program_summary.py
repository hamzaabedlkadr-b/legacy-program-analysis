...
def main():
    ...
    matches = [d for d in docs if d.get("type") == "program.summary" and d.get("program") == args.program]
    if not matches:
        raise SystemExit(f"program.summary not found for program: {args.program}")
