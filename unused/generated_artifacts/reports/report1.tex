...
The graph is then enriched using the script \texttt{scripts/pipeline/enrich\_graph.py}, producing \texttt{pdc\_enriched.json}. During this enrichment phase several improvements were introduced:
...
\hline
\texttt{pdc.json} & \texttt{scripts/pipeline/enrich\_graph.py} & \texttt{pdc\_enriched.json} \\
\hline
\end{tabular}
